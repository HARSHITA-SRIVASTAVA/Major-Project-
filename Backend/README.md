...
# 🧠 Mental Health Analysis System – Backend
...
1. User input (text + questionnaire)
2. Text → Emotion detection (BERT model)
3. Questionnaire → Risk prediction (ML model)
4. Hybrid logic combines both outputs
5. Final risk level generated
